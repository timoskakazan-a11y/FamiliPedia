...
[^1]: She even won the local "Best Rose" competition three years in a row, from 1988 to 1990.`,
        ...
        banners: [
            { type: 'neutrality', text: 'Стиль этой статьи может быть не нейтральным. Пожалуйста, улучшите её, чтобы она соответствовала стандартам энциклопедии.' },
            { type: 'unverified', text: 'Информация в этой статье не проверялась с 15 августа 2024 года.' }
        ]
    },
    {
        id: '2',
        ...
        lockInfo: {
            locked: true,
            reason: 'Статья временно заблокирована из-за споров о точности представленных фактов.'
        }
    },
    {
        id: '3',
    ...
    },
    {
        ...
        lockInfo: {
            locked: true,
            reason: 'Статья временно заблокирована из-за споров о точности представленных фактов. Глав редакция на основе личного представления и способов целесообразности принила решение прекратить поддежривать актуальность данных статьи, ее фотографий и терминов.'
        }
    }
