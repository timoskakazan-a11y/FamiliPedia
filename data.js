...
[^1]: She even won the local "Best Rose" competition three years in a row, from 1988 to 1990.`,
    ...
    },
    {
        ...
        // --- НОВЫЙ ЭКРАН БЛОКИРОВКИ ДЛЯ ПРИМЕРА ---
        lockInfo: {
            locked: true,
            reason: 'Эта статья заблокирована для редактирования в связи с продолжающимся спором о содержании.'
        }
    },
    {
        id: '3',
